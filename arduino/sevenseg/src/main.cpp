...
void loop() {
    ...
    delay(1000);
    disp_sevenseg(1,0,0,1,1,1,1);
    delay(1000);
    disp_sevenseg(0,0,1,0,0,1,0);
    delay(1000);
    disp_sevenseg(0,0,0,0,1,1,0);
    delay(1000);
    disp_sevenseg(1,0,0,1,1,0,0);
    delay(1000);
    disp_sevenseg(0,1,0,0,1,0,0);
    delay(1000);
    disp_sevenseg(0,1,0,0,0,0,0);
    delay(1000);
    disp_sevenseg(0,0,0,1,1,1,1);
    delay(1000);
    disp_sevenseg(0,0,0,0,0,0,0);
    delay(1000);
    disp_sevenseg(0,0,0,0,1,0,0);
    delay(1000);
}
